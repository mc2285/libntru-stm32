...
__attribute__((section("._ram_d1"))) static int64_t UNIFORM_BUF[NTRU_PADDED_N*11], UNIFORM_MEM[NTRU_PADDED_N*11];
    ...
    unsigned char       *sk)
{
    ...
    */
    ...
    keygen(f,g,g_inv,h,UNIFORM_BUF,param);
    ...
    const unsigned char *sk)
{
    ...
    */
    ...
    memset(UNIFORM_BUF,0, sizeof(int64_t)*param->padded_N*11);
    memset(UNIFORM_MEM,0, sizeof(int64_t)*param->padded_N*5);
    ...
    const unsigned char *pk)
{
    ...
    */
    ...
    memset(UNIFORM_BUF,0, sizeof(int64_t)*param->padded_N*7);
    memset(UNIFORM_MEM,0, sizeof(int64_t)*param->padded_N*5);
    ...
    */
    ...
    if(verify(sig, m, *mlen, h,UNIFORM_BUF,param)!=0)
    {
        return -1;
    }
    else
